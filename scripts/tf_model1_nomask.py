...
class ObjectDetectionTF():
    ...
    # Actual detection.
        ...
        t3 = time.time()
	print('>>>>>>> Time for the model >>>>>>',t3-t2)
		...
		tx2 = time.time()
		print('XXXXX write to pose in other file XXXXX',tx2-tx1)
        ...
        t4 = time.time()
	print('MMMMM time for writing pose MMMMM',t4-t3)  
